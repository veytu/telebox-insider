...
import { ValManager, Val, combine, withReadonlyValueEnhancer, withValueEnhancer, derive } from "value-enhancer";
...
class TeleBox {
  ...
  _renderStage() {
    ...
    this._sideEffect.addDisposer([
      combine([this._stageStyle$, this._defaultBoxStageStyle$], ([stageStyle, defaultBoxStageStyle]) => stageStyle != null ? stageStyle : defaultBoxStageStyle).subscribe((styles) => {
...
const ResizeObserver = window.ResizeObserver || ResizeObserver$2;
