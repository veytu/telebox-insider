...
export class TeleBox {
    public constructor({
        ...
        this._valSideEffectBinder = createSideEffectBinder(
    ...
    protected readonly addObserver: (
        el: HTMLElement,
    ...
    public render(root?: HTMLElement): HTMLElement {
        ...
        $contentWrap.className =
            this.wrapClassName("content-wrap") + " tele-fancy-scrollbar";
        ...
        this.addObserver($contentWrap, (data) => {
            ...
            if (entry?.target == $contentWrap) {
                $content.style.width =
                    entry.contentRect.width * this.scale.value + "px";
                $content.style.height =
                    entry.contentRect.height * this.scale.value + "px";
            }
        });

        this.scale.reaction((scale) => {
            $content.style.width =
                $contentWrap.getBoundingClientRect().width * scale + "px";
            $content.style.height =
                $contentWrap.getBoundingClientRect().height * scale + "px";
        });
